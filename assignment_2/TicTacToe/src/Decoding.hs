...
readExternalDictionaryContent string acc =
	...
	in readExternalDictionaryContent left' (acc ++ [move])
...
removeDictionaryBrackets badFormatMessage = error $ "expected 'd' at the start and 'e' at the end of the string" 
	++ "Got: " ++ [(head badFormatMessage)]
